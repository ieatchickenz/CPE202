...
class LinearHash():
    ...
    def make_table_linear(self, filename):
        """This function takes the list with no stopwords and inserts them
            ...
            Returns:
                this function updates the hash table
        """
        file = open(filename, "r")
    ...
    def get_tablesize(self):
        """This function returns the length of the hash table
            Args:
                This function takes no arguments
            Returns:
                This function returns the tsize attribute
        """
        return self.tsize

    def read_file(self, filename):
        """read words from input file and insert them into hash table, after processing
         for punctuation, numbers and filtering out stop words in the stop_table
         Args:
            filename - the name of the input file
        Returns:
            returns a Hash table of words not including stop words
        """
        file = open(filename, "r")
        list_lines = file.readlines()
        file.close()
    ...
    def make_new_hash(self, list_no_stop, line_list):
        """This function makes a hash table of the list with no stop words
            Args:
                list_no_stop(list) - list of words with no stop words
    ...
    def save_concordance(self, output_file):
        """This function returns an output file of words and their lines
            Args:
                output_file - the file that everything is written to
            Returns:
                an output file
        """
        string = ""
        ...
        def custom_sort(listings):
            """This function is to tell the sort function which item to sort the list by
            """
            return listings[0]
    ...
    def get_load_factor(self):
        """This function calculates the load factor of the hash table
            Args:
                No arguments
            Returns:
                The load factor
